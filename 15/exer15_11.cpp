...
public:
    ...
    void debug(ostream &os) const override {
        os << " bookNo " << bookNo << " price " << price  << " min_qty " <<min_qty << " discount " << discount << endl;    
    }
private:
    size_t min_qty = 0;
    double discount = 0.0;
...
public:
    ...
    void debug(ostream &os) const override {
        os << " bookNo " << bookNo << " price " << price  << " max_qty " <<max_qty << " discount " << discount << endl;    
    }
private:
    size_t max_qty = 0;
    double discount = 0.0;
